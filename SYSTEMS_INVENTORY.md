...
**Last updated:** 2026-08-24 — added cocard/approve, merchant-form, decrypt-tool, eula, privacy-policy, icons/preview; removed quote-builder; added 3 n8n CRM exports (convert-lead, send-form, merchant-form-submit)
...
| `cocard/approve.html` | CoCard action approval page (used by n8n approval flows) |
| `leads/merchant-form.html` | Public merchant application form |
...
| `icons/preview.html` | Icon preview utility (dev reference) |
...
| `n8n/crm/convert-lead.json` | Convert lead to active customer |
