...
**Last updated:** 2026-07-20 — added cocard/approve, eula, privacy-policy, icons/preview, leads/merchant-form, leads/decrypt-tool; removed leads/quote-builder (file gone); added 3 CRM n8n exports
...
| `cocard/approve.html` | CoCard approval action page |
| `eula.html` | End User License Agreement — IMG Services FM Invoicing App |
| `privacy-policy.html` | Privacy Policy — IMG Services FM Invoicing App |
| `icons/preview.html` | Icon preview tool for CoCard apps |
| `leads/merchant-form.html` | Merchant Application Form |
...
| `email-remove-hold.html` | FM remove hold email template |
| `email-close-account.html` | FM close account email template |
...
| `n8n/crm/convert-lead.json` | Convert lead to customer workflow |
| `n8n/crm/merchant-form-submit.json` | Merchant form submitted handler |
