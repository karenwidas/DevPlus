...
**Last updated:** 2026-06-29 — added merchant-form, decrypt-tool, approve, email templates, eula, privacy-policy, icons/preview; removed quote-builder (not found); added 3 n8n CRM exports
...
| `leads/merchant-form.html` | Public-facing merchant application form (encrypted submission) |
| `leads/decrypt-tool.html` | Internal merchant application viewer / decryptor |
| `cocard/approve.html` | Action approval landing page (approve via email link) |
| `email-date-request.html` | FM season date request email template |
| `email-remove-hold.html` | FM season remove-hold email template |
| `email-close-account.html` | FM season close-account email template |
| `eula.html` | EULA — IMG Services FM Invoicing App |
| `privacy-policy.html` | Privacy Policy — IMG Services FM Invoicing App |
| `icons/preview.html` | Icon preview page for CoCard app icons |
...
| `n8n/crm/send-form.json` | Send merchant application form link |
| `n8n/crm/merchant-form-submit.json` | Handle merchant application form submission |
| `n8n/crm/convert-lead.json` | Convert lead to customer / create merchant account |
